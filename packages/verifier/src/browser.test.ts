...
function createGenuinePassport(): { passport: Passport; artifacts: Record<string, string> } {
  ...
  const manifest: PassportManifest = {
    ...
    project: { name: "Browser verifier parity", repositoryCommit: "0123456789abcdef" },
  ...
  const evidenceDigestSha256 = createEvidenceDigest("codex-exec-json", events).inputDigestSha256;
