...
- Current state: only the project creator is listed.
- No teammate changes were made.
- Private invite information was not copied into repository files.
...
- Required Markdown project story.
- Required built-with tags, maximum 25.
...
- Optional single file upload, maximum 35 megabytes.
- Required submitter type: Individual, Team of Individuals, or Organization.
- Required country of residence.
- Required track selection.
- Required public or private repository Uniform Resource Locator.
